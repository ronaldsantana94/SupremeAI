...
const faqs = [
    {
      q: "What AI models does SupremeAI support?",
      a: "SupremeAI integrates OpenAI (GPT-4o), Google Gemini, Claude, and Grok, allowing seamless switching between models.",
    },
    {
      q: "Is SupremeAI free to use?",
      a: "We offer a free plan with limited access. Unlock all AI models and features with our Pro plan.",
    },
    {
      q: "Can I use SupremeAI for professional work?",
      a: "Absolutely! SupremeAI is designed for content creators, developers, and businesses who need high-quality AI assistance.",
    },
    {
      q: "How does SupremeAI compare to ChatGPT?",
      a: "Unlike ChatGPT, SupremeAI allows you to compare responses from multiple AI models in a single platform.",
    },
    {
...
const reviews = [
    {
      name: "Alex J.",
      role: "AI Researcher",
      content: "SupremeAI makes switching between OpenAI, Gemini, and Claude seamless! The best AI platform I've used so far.",
      rating: 5,
      date: "Feb 20, 2024"
    },
    {
    ...
    },
    {
      name: "Daniel M.",
      role: "Entrepreneur",
      content: "I use SupremeAI daily to automate research and content generation. The results are way better than standalone AI tools.",
      rating: 5,
      date: "Jan 15, 2024"
    },
    {
    ...
    },
    {
      ...
      content: "The Grok integration is insane. SupremeAI gives me the flexibility to test different AI models without switching apps.",
      rating: 5,
      date: "Mar 10, 2024"
    },
    {
      ...
      content: "Our entire marketing team now relies on SupremeAI for content ideation. It's like having an AI assistant on steroids!",
      rating: 5,
      date: "Feb 28, 2024"
    }
  ];
...
<section className="pt-32 pb-20 text-center bg-gray-100 dark:bg-black">
  <div className="container mx-auto px-6">
    ...
    <p className="text-sm text-white bg-gradient-to-r from-orange-600 to-red-600 px-5 py-2 inline-block rounded-full font-medium tracking-wide">
      SupremeAI: Multimodal AI with OpenAI, Gemini, Claude & Grok
    </p>
...
<section className="py-20 bg-white dark:bg-[#0D0D0D]">
    ...
    <div className="relative max-w-4xl mx-auto">
      ...
      {/* Section Subtitle */}
      <p className="text-gray-600 dark:text-gray-300 mt-3 mb-12">
        SupremeAI is designed to be intuitive and easy to use.
      </p>
  ...
  >
    ...
    {activeTooltip === spot.id && (
      ...
      <div className="container mx-auto px-6">
        ...
        <p className="text-gray-600 dark:text-gray-300 text-center mt-3 mb-12">
          Everything you need to know about SupremeAI.
        </p>
        ...
        <p className="mb-8 text-lg text-white/90 max-w-2xl mx-auto">
          Join thousands of professionals who trust SupremeAI for their AI-powered workflow.
        </p>
